...
intro_panel <- tabPanel(
  ...
  img("Example NYT chart" ,src = "inequality.png"),

  # A paragraph containing a hyperlink `a()` to the source of the article at
  # https://www.nytimes.com/interactive/2017/08/07/opinion/leonhardt-income-inequality.html
  p(
    a("link to source", href = "https://www.nytimes.com/interactive/2017/08/07/opinion/leonhardt-income-inequality.html")
  ),
  ...
  # text.
  p("something something about", strong("inequality"), "and something more", em("inequality"))
)
...
main_content <- mainPanel(
  ...
  p(
    a("link to data source", href = "http://gabriel-zucman.eu/usdina/")
  )
)
